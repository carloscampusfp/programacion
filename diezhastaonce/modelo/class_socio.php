...
class Socio
{
    ...
    public function agregarSocio($nombre, $apellido, $email, $telefono, $fecha_nacimiento)
    {
        ...
        if ($stmt->execute()) {
            echo "<div class='alert alert-success'>Socio agregado con éxito.</div>";
        } else {
            echo "<div class='alert alert-danger'>" . "Error al agregar socio: " . $stmt->error . "</div>";
        }
    ...
    public function actualizarSocio($id_socio, $nombre, $apellido, $email, $telefono, $fecha_nacimiento)
    {
        ...
        if ($stmt->execute()) {
            echo "<div class='alert alert-success'>Socio actualizado con éxito.</div>";
        } else {
            echo "<div class='alert alert-danger'>" . "Error al actualizar socio: " . $stmt->error . "</div>";
        }
