...
if($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $precio = (float)$_POST["precio"] ?? null; #hay que cambiar esto por el calculo del precio en funcion del plan

    try{
        $controlador = new Usuario();
        $controlador->agregarUsuario($nombre, $apellidos, $correo, $edad, $plan, $paquete, $duracion, $precio);
...
<div class="container mt-5">
        <h1 class="text-center mb-4 text-primary">Añadir Usuario</h1>
        <form action="alta.php" method="POST" class="p-4 shadow-lg rounded-4 bg-light">
            <!-- Campo de Nombre -->
            <div class="mb-3">
